...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the iso.std.iso_iec._24727.tech.schema package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _CardApplicationServiceDeleteResponse_QNAME = new QName("urn:iso:std:iso-iec:24727:tech:schema",
	...
	private final static QName _CardApplicationServiceLoadResponse_QNAME = new QName("urn:iso:std:iso-iec:24727:tech:schema",
			"CardApplicationServiceLoadResponse");
	private final static QName _CardApplicationDisconnectResponse_QNAME = new QName("urn:iso:std:iso-iec:24727:tech:schema",
	...
	private final static QName _CardApplicationServiceCreateResponse_QNAME = new QName("urn:iso:std:iso-iec:24727:tech:schema",
	...
	private final static QName _CardApplicationEndSessionResponse_QNAME = new QName("urn:iso:std:iso-iec:24727:tech:schema",
			"CardApplicationEndSessionResponse");
	...
	// *
	// */
	// public ISO78164CardCapabilitiesType.SecondSoftwareFunctionTable.DataUnitSizeInQuartets
	// createISO78164CardCapabilitiesTypeSecondSoftwareFunctionTableDataUnitSizeInQuartets() {
	...
	// *
	// */
	// public ISO78164CardCapabilitiesType.ThirdSoftwareFunctionTable.LogicalChannelSupport
	// createISO78164CardCapabilitiesTypeThirdSoftwareFunctionTableLogicalChannelSupport() {
	...
	// *
	// */
	// public ISO78164CardCapabilitiesType.ThirdSoftwareFunctionTable.LogicalChannelSupport.NumberOfLogicalChannels
	// createISO78164CardCapabilitiesTypeThirdSoftwareFunctionTableLogicalChannelSupportNumberOfLogicalChannels() {
	...
	// *
	// */
	// public ISO78164CardCapabilitiesType.SecondSoftwareFunctionTable.BehaviourOfWriteFunctions
	// createISO78164CardCapabilitiesTypeSecondSoftwareFunctionTableBehaviourOfWriteFunctions() {
	...
	// public JAXBElement<ResponseType> createDIDDeleteResponse(final ResponseType value) {
	...
	// public JAXBElement<CardCallType> createCardCall(final CardCallType value) {
	...
	// public JAXBElement<CardApplicationType> createApplicationInfo(final CardApplicationType value) {
	...
	// public JAXBElement<CardInfoType> createCardInfo(final CardInfoType value) {
	...
	// public JAXBElement<ResponseType> createDisconnectResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createACLModifyResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationServiceDeleteResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createTCAPICloseResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationServiceLoadResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationDisconnectResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDataSetDeleteResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDIDCreateResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createEndTransactionResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDSIDeleteResponse(final ResponseType value) {
	...
	// public JAXBElement<RequestType> createInitialize(final RequestType value) {
	...
	// public JAXBElement<ResponseType> createReleaseContextResponse(final ResponseType value) {
	...
	// public JAXBElement<StateInfoType> createStateInfo(final StateInfoType value) {
	...
	// public JAXBElement<ResponseType> createDIDUpdateResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createVerifyCertificateResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationCreateResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationDeleteResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createOutputResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCancelResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationServiceCreateResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDSIWriteResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createInitializeResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDataSetCreateResponse(final ResponseType value) {
	...
	public JAXBElement<ConclusionType> createConclusion(final ConclusionType value) {
	...
	// public JAXBElement<ResponseType> createVerifySignatureResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createBeginTransactionResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDSICreateResponse(final ResponseType value) {
	...
	// public JAXBElement<RequestType> createTerminate(final RequestType value) {
	...
	// public JAXBElement<ResponseType> createCardApplicationEndSessionResponse(final ResponseType value) {
	...
	public JAXBElement<ResponseType> createStartPAOSResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createDataSetSelectResponse(final ResponseType value) {
	...
	// public JAXBElement<ResponseType> createTerminateResponse(final ResponseType value) {
	...
	// public JAXBElement<DIDAuthenticationStateType> createStateTransitionTypeDIDAuthenticationState(final DIDAuthenticationStateType value) {
	// return new JAXBElement<DIDAuthenticationStateType>(_StateTransitionTypeDIDAuthenticationState_QNAME, DIDAuthenticationStateType.class,
	// StateTransitionType.class, value);
	// }
	//
	// /**
	...
	// public JAXBElement<CardCallSequenceType> createStateTransitionTypeFixedProcedure(final CardCallSequenceType value) {
	...
	// public JAXBElement<BigInteger> createStateTransitionTypeRetryCounter(final BigInteger value) {
	...
	// public JAXBElement<BigInteger> createStateTransitionTypeUsageCounter(final BigInteger value) {
