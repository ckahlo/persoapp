 ...
 *         &lt;element ref="{urn:iso:std:iso-iec:24727:tech:schema}CardInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddCardInfoFiles")
public class AddCardInfoFiles
    extends RequestType
{

    @XmlElement(name = "ChannelHandle")
    protected ChannelHandleType channelHandle;
    @XmlElement(name = "CardInfo", namespace = "urn:iso:std:iso-iec:24727:tech:schema", required = true)
