...
public interface IFD {
	 ...
	 * 
	 * @param parameters
	 * @return returns iso.std.iso_iec._24727.tech.schema.TransmitResponse
	 */
	...
	public TransmitResponse transmit(
			@WebParam(name = "Transmit", targetNamespace = "urn:iso:std:iso-iec:24727:tech:schema", partName = "parameters") Transmit parameters);
