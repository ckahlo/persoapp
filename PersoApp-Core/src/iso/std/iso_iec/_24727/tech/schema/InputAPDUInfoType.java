...
import de.persoapp.core.util.MyHexBinaryAdapter;

/**
 * <p>
 * Java class for InputAPDUInfoType complex type.
 * 
 * <p>
...
@XmlType(name = "InputAPDUInfoType", propOrder = { "inputAPDU", "acceptableStatusCode" })
public class InputAPDUInfoType {

	@XmlElement(name = "InputAPDU", required = true, type = String.class)
	@XmlJavaTypeAdapter(MyHexBinaryAdapter.class)
	 ...
	 * 
	 */
	public void setInputAPDU(final byte[] value) {
	 ...
	 * <CODE>set</CODE> method for the acceptableStatusCode property.
	 * 
	 * <p>
