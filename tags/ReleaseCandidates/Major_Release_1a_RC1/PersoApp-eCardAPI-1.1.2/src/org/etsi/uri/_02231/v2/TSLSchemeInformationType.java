 ...
 *         &lt;element name="TSLType" type="{http://uri.etsi.org/02231/v2.x#}NonEmptyURIType"/>
 *         &lt;element name="SchemeOperatorName" type="{http://uri.etsi.org/02231/v2.x#}InternationalNamesType"/>
 *         &lt;element name="SchemeOperatorAddress" type="{http://uri.etsi.org/02231/v2.x#}AddressType"/>
 *         &lt;element name="SchemeName" type="{http://uri.etsi.org/02231/v2.x#}InternationalNamesType"/>
 *         &lt;element name="SchemeInformationURI" type="{http://uri.etsi.org/02231/v2.x#}NonEmptyMultiLangURIListType"/>
 *         &lt;element name="StatusDeterminationApproach" type="{http://uri.etsi.org/02231/v2.x#}NonEmptyURIType"/>
 *         &lt;element name="SchemeTypeCommunityRules" type="{http://uri.etsi.org/02231/v2.x#}NonEmptyURIListType" minOccurs="0"/>
 *         &lt;element ref="{http://uri.etsi.org/02231/v2.x#}SchemeTerritory" minOccurs="0"/>
 *         &lt;element ref="{http://uri.etsi.org/02231/v2.x#}PolicyOrLegalNotice" minOccurs="0"/>
 *         &lt;element name="HistoricalInformationPeriod" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger"/>
 *         &lt;element ref="{http://uri.etsi.org/02231/v2.x#}PointersToOtherTSL" minOccurs="0"/>
 *         &lt;element name="ListIssueDateTime" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
 *         &lt;element ref="{http://uri.etsi.org/02231/v2.x#}NextUpdate"/>
 *         &lt;element name="SchemeExtensions" type="{http://uri.etsi.org/02231/v2.x#}ExtensionsListType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
