...
public class CardHandler implements ICardHandler {
	...
	private CardHandler(final IMainView mainView) {
		this.mainView = mainView;
	}

	public static final CardHandler getInstance(final IMainView mainView) {
		try {
			Class.forName("javax.smartcardio.TerminalFactory");
		} catch (final Exception e) {
			System.err.println("No javax smartcard support available.");
			return null;
		}

		return new CardHandler(mainView);
	}
